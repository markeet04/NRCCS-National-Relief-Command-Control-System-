...
export class MissingPerson {
    ...
    @Column({ type: 'varchar', length: 20, nullable: true, name: 'case_reference' })
    ...
    @Column({ type: 'varchar', length: 150, nullable: true, name: 'reporter_name' })
    reporterName: string;

    @Column({ type: 'varchar', length: 20, nullable: true, name: 'reporter_phone' })

...
export class NdmaController {
  ...
  async getAllDistricts(
    ...
    return await this.ndmaService.getAllDistricts(
      user,
      parsedProvinceId,
      riskLevel,
    );
  ...
  async getAllAlerts(
    ...
    const parsedProvinceId = provinceId ? parseInt(provinceId, 10) : undefined;
    return await this.ndmaService.getAllAlerts(
      user,
      status,
      severity,
      parsedProvinceId,
  ...
  async getAllShelters(
    ...
    const parsedProvinceId = provinceId ? parseInt(provinceId, 10) : undefined;
    return await this.ndmaService.getAllShelters(
      user,
      status,
      parsedProvinceId,
    );
  ...
  async allocateResourceToProvince(
    ...
    return await this.ndmaService.allocateResourceToProvince(
      id,
      allocateDto,
      user,
    );
  ...
  async getAllocationHistory(
    ...
    const parsedProvinceId = provinceId ? parseInt(provinceId, 10) : undefined;
    return await this.ndmaService.getNdmaAllocationHistory(
      user,
      parsedProvinceId,
    );
  }
  ...
  async getAllSosRequests(
    ...
    const parsedProvinceId = provinceId ? parseInt(provinceId, 10) : undefined;
    return await this.ndmaService.getAllSosRequests(
      user,
      status,
      priority,
      parsedProvinceId,
  ...
  async getAllRescueTeams(
    ...
    const parsedProvinceId = provinceId ? parseInt(provinceId, 10) : undefined;
    return await this.ndmaService.getAllRescueTeams(
      user,
      status,
      parsedProvinceId,
    );
  ...
  async predictFlood(
    ...
    // Get ML prediction
    const prediction = await this.floodPredictionService.predict(
      floodPredictionDto,
      user,
    );

...
const CircularResourceGauge = ({ 
  ...
  return (
    <div className="pdma-circular-gauge">
      <svg 
        width={size} 
        height={size} 
        viewBox={`0 0 ${size} ${size}`}
        className="pdma-circular-gauge-svg"
      >
        {/* Background track */}
        <circle
          cx={center}
          ...
          r={radius}
          fill="none"
          className="pdma-circular-gauge-track"
        ...
        <circle
          ...
          className="pdma-circular-gauge-progress"
        />
      </svg>
      <span 
        className="pdma-circular-gauge-text"
